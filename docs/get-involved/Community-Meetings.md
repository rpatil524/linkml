...
| [October 16, 2025](https://docs.google.com/presentation/d/1n_UvJ7dMieaENLFNrPlgoTpUlgQg0axQS1BTyrXxBo0/edit?slide=id.g36e69bd970c_1_50#slide=id.g36e69bd970c_1_50)	| Community Discussion Topics | (1) Multilingual support; (2) ID handling; (3) Likert enumerations |	-	| - |
| [September 18, 2025](https://docs.google.com/presentation/d/1fVYxth4vROhAc-GuU6mx99sdSH-UekjdXqZZHGm9y5w/edit?slide=id.g36e69bd970c_1_50#slide=id.g36e69bd970c_1_50) | Joonas Kesäniemi	| Adapting existing RAiD service implementation with LinkML - Generating artefacts for initialization. documentation, and validation | Corey Cox	| The Data Model-Based Ingestion Pipeline Pilot ([dm-bip](https://github.com/linkml/dm-bip)) |
| [August 21, 2025](https://docs.google.com/presentation/d/1RRDVeAAup3DCOR4vxPi4Mv6dL54dCDKJDcGvhd6II1s/edit)	| Caterina Strambio De Castillia |	A LinkML-based metadata framework for the Open Microscopy Metadata model to enable easy extension, data exchange with instrument manufacturers, and integration with related models.	| Frank Dekervel	| LinkML in Rust |
| [July 17, 2025](https://docs.google.com/presentation/d/1Mkjjnf07cOwbp0UMO2yoHB2Yx3cd0uuLYB6S63Mm5X0/edit?slide=id.g36e69bd970c_1_50#slide=id.g36e69bd970c_1_50) |	Lex Jansen	| Modeling at CDISC with LinkML	| - |	- |
| June 20, 2025 |	Matt Diller	| Modeling CDEs with LinkML	| Anson Parker	| Lexipedia + Merging legal ontologies |
| May 15, 2025	| Damion Dooley	| Recent developments in DataHarmonizer	| Corey Cox |	"deprecation protocol" and best practices for feature deprecation in LinkML |
| April 17, 2025 |	Adrian Gschwend	| Demonstrating LinkML output of a new DSL data modeling specification |- |	- |
| March 20, 2025	| Tim Fliss	| Pandera generator |	Mark Miller	| MIxS Implementation Of LinkML |
| February 20, 2025	| Marco Mesiti & Emanuele Cavalleri	| SchemaLink demo / Q&A |	-	| - |
